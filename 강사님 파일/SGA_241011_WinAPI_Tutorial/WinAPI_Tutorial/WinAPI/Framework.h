...
//. 키보드 관련 매크로
#define KEY_DOWN(k) Keyboard::Get()->Down(k)	// 키 누를때
#define KEY_UP(k) Keyboard::Get()->Up(k)	// 키 뗄떼
#define KEY_PRESS(k) Keyboard::Get()->Press(k)	// 키를 누르고 있을때
