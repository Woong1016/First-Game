...
// 그래서, 클래스가 뭐였더라? 프로그램을 하나의 작품이라고 비유했을 때,
...
// 현실의 객체가 가지는 상호 관계는 다시 나누면 크게 두 가지
...
// 떼어놓을 수 없는 C, D의 객체가 있고, 한쪽이 다른 한쪽을 포함하는 것.

// 학원과 강사, 가족과 가족의 구성원, 사람과 그 사람의 행동, 그리고....

// 사람과 그 사람의 '신분' 혹은 '정체성' 이런 것도 소속이다

// 특히 예시가 뒤로 갈수록 포함의 개념이 소속된 개념과 크게 다르지 않기도 하다

// 예 : "나라는 사람과" + "나의 신분" <- 제3자 입장에서 보면 그게 그거 아니냐?



// 그러면, 클래스가 프로그래밍이 가능한 문법이니까

// 이런 클래스 간의 관계 또한 프로그래밍 가능한 문법으로 존재하지 않을까?
...
// -> 오늘의 진도 : 클래스가 소속의 관계를 가질 때, 문법으로 구현하는 법
