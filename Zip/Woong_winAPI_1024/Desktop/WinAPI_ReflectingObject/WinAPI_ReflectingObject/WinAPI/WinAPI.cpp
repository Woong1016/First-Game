...
// 1. 필수 : 벡터의 정규화, 선분의 반사 개념을 한번 더 찾아보도록 합시다.
//           사실 오늘 알아보지 않은 부분에서도 나중에 알아봐야 할 반사 벡터 식 등이
//            존재하기도 하거든요. 힘 닿는 범위에서 한번 찾아보고...
//            정리하거나, 메모를 포스팅해봅시다.

// 2. 옵션 : 벽돌깨기... 혹시 시간 되시는 분들은 도전해봅시다.
//           벽돌깨기 개발에 만약 성공하셨다면...

//           공이 여러 개 나오는 벽돌 깨기에도 도전해봅시다.
//           아니면... 벽돌에 HP가 있는 것도 좋겠네요.
