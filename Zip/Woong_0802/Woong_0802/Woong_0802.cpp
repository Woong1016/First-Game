...
//2. 빙고 판에는 1~25까지의 숫자가 랜덤으로 들어갑니다.

//3. 빙고 판에  각 숫자를 중복되지 않도록 랜덤으로 배치해주세요 .

// 4. 플레이어는 가로 몇번째 , 세로 몇 번째 칸을 지우려는지 입력하게 해주세요

// 5. 입력이 들어온 칸은 지우집니다. " 지워졌음을 눈으로 확인할 수 있게 해주세요

//	(숫자가 바뀌어도 되고 다른 문자로)

// 6. 가로 , 세로 , 대각선 어느 방향으로든 한줄이 모두 지워지면 빙고 한줄이 됩니다.

// 7. 빙고가 5줄이 되면 게임이 끝나게 해주세요
...
//하지만 마지막 단꼐에서는 컴퓨터가 최선의 수만을 두도록 해주세요
